...
// Lista de facturas + flujo de añadir factura (ingreso) o gasto.
// El OCR de gastos pasa por Claude Haiku para extracción estructurada.

import { useState, useMemo } from "react";
import { B, fmt, hoy, convD, applyF } from "../utils.js";
import { useResponsive } from "../hooks/useResponsive.js";
import { createRecord, deleteRecord, findOrCreateClient, runOCR, parseExpense } from "../api.js";
import { Card, Lbl, Inp, Sel, Sem, FilterBar, SectionHeader, ErrorBox, SuccessBox } from "./UI.jsx";
...
// ============================================================
// FORMULARIO DE NUEVA FACTURA / GASTO
// ============================================================
function NuevoForm({ onClose, onSaved }) {
  ...
  const handleFile = async (file) => {
    ...
    try {
      ...
      if (tipo === "ingreso") {
        // Parser regex tradicional (tu plantilla controlada)
        ...
        // Gasto: pasamos por Claude para entender cualquier formato
